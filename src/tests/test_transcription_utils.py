...
from src.api.config import WHISPERX_API_DATA_PATH
...
def test_run_whisperx(mocker):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        expected_cmd = f"whisperx test.mp3 --model base --language en --hf_token {HF_TOKEN} --output_format all --output_dir {WHISPERX_API_DATA_PATH}  --align_model WAV2VEC2_ASR_LARGE_LV60K_960H --diarize --min_speakers 1 --max_speakers 2"
